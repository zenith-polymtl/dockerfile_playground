...
def generate_launch_description():
    ...
    position_node = Node(
            ...
            parameters=[{
                ...
                # Rates / filters
                'alpha': 0.1, #Higher means more rate v_r rate allowed
                ...
                # pid_r
                'pid_r_kp': 3.75, 'pid_r_ki': 1.0, 'pid_r_kd': 0.15, 'pid_r_max_i': 0.25, 'pid_r_max_out': 7.0, 'pid_r_deriv_tau': 0.0, 'pid_r_d_clip': 1.0,
                # pid_r_abs
                ...
                # pid_v_theta
                'pid_v_theta_kp': 2.5, 'pid_v_theta_ki': 1.0, 'pid_v_theta_kd': 0.0, 'pid_v_theta_max_i': 0.2, 'pid_v_theta_max_out': 2.25, 'pid_v_theta_deriv_tau': 0.0, 'pid_v_theta_d_clip': 0.3,
                # pid_z
