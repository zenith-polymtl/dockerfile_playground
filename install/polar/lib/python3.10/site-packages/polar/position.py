...
class ApproachNode(Node):
    def __init__(self):
        ...
        self.yaw_pub = self.create_publisher(Float32, '/yaw_target', qos_profile)
    ...
    def compute_estimated_state(self):
        ...
        angle_towards_target = np.arctan2(delta_x, delta_y)*180/np.pi
        self.yaw_pub.publish(Float32(data=angle_towards_target))
